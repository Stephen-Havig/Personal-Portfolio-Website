    ...
    <div class="page-banner">
      ...
      <div class="page-banner__content container container--narrow">
        ...
        <div class="page-banner__intro">
          <!-- <p>“The most important step a man can take. It's not the first one, is it?
It's the next one. Always the next step."</p> -->
        </div>
      </div>
    </div>
    ...
    <?php 
    $checkChildrenArray = get_pages(array(
        'child_of' => get_the_ID()
    ));

    if ($theParent or $checkChildrenArray) { ?>
